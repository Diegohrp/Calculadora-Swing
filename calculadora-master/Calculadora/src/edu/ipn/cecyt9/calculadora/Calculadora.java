	...
	private void calcularResultado() {
		if (operacion.equals("+")) {
			...
			resultado *= new Double(pantalla.getText());
                                ...
                                if (operacion.equals("^")) {
			resultado = (double)Math.pow(resultado,new Double(pantalla.getText()));
		} else 
                                    if (operacion.equals("^1/2")) {
			resultado = (double)Math.pow(resultado,.5);
		} else 
